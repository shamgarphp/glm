...
class Department extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['file'] = 'department/deparments/department_list';
    ...
    {      
        ...
        // {
            ...
            //$data['file'] = 'department/deparments/user_events';
            //$data['custom_css']        = 'department/deparments/calender/css';
            // $data['custom_js']       = 'location/location/js/location_js';
            $this->load->view('department/deparments/user_events');  
        // }
        // else
        // {
    ...
    {      
        ...
        // {
            // $serviceid              = base64_decode($_GET['idservice']);
            // $data['service_view']     = $this->Service_model->service_view($serviceid);
            $data['file']           = 'department/deparments/department_view';
