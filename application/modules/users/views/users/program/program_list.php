  ...
  <div class="m-content">
   ...
   <div class="m-portlet m-portlet--mobile">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable employees" id="m_table_2">
                  ...
                  <tbody>
                  <?php if(isset($program_list) && !empty($program_list)){?>
                  <?php $i = 1; foreach($program_list as $program){?>
                  <tr>
                    <td>
                    <p class="check_select checkboxes"><input type="checkbox" name="quetions_list[]" id="quetions_list<?php echo $program['program_id']; ?>" value="<?php  echo $program['program_id']; ?>"><label for="quetions_list<?php echo $program['program_id']; ?>"></label></p>
                   </td>
                    <td> <?php echo $i++; ?> </td>
                    <td><?php if(!empty($program['program_name'])) { echo ucfirst($program['program_name']);} ?> </td>
                    <td><?php if(!empty($program['program_aim'])) { echo ucfirst($program['program_aim']);} ?> </td>
                    <td> <?php if(!empty($program['area'])) { echo ucfirst($program['area']);} ?> </td>
                    <td> <?php if(!empty($program['created_on'])) { echo ucfirst($program['created_on']);} ?> </td>
