  ...
  <div class="m-content">
   ...
   <div class="m-portlet m-portlet--mobile">
                  ...
                  <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                      ...
                      <h4><a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air"
                        ><i class="fas fa-plus"></i>Add Fund</a></h4>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable employees" id="m_table_2">
                  ...
                  <tbody>
                  <?php if(isset($fund_list) && !empty($fund_list)){?>
                  <?php $i = 1; foreach($fund_list as $fund){?>
                  <tr>
                    <td>
                    <p class="check_select checkboxes"><input type="checkbox" name="quetions_list[]" id="quetions_list<?php echo $fund['fund_id']; ?>" value="<?php  echo $fund['fund_id']; ?>"><label for="quetions_list<?php echo $fund['fund_id']; ?>"></label></p>
                   </td>
                    <td> <?php echo $i++; ?> </td>
                    <td><?php if(!empty($fund['program_name'])) { echo ucfirst($fund['program_name']);} ?> </td>
                    <td><?php if(!empty($fund['allocate_fund'])) { echo ucfirst($fund['allocate_fund']);} ?> </td>
                    <td> <?php if(!empty($fund['advance_issued'])) { echo ucfirst($fund['advance_issued']);} ?> </td>
                    <td> <?php if(!empty($fund['apply_for_advance'])) { echo ucfirst($fund['apply_for_advance']);} ?> </td>
                    <td> <?php if(!empty($fund['description'])) { echo ucfirst($fund['description']);} ?> </td>
                    <td> <?php if(!empty($fund['created_on'])) { echo ucfirst($fund['created_on']);} ?> </td>   
                    <td>
                      <p>
