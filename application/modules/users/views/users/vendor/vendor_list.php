  ...
  <div class="m-content">
   ...
   <div class="m-portlet m-portlet--mobile">
                  ...
                  <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                      ...
                      <h4><a href="#" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air"
                        ><i class="fas fa-plus"></i>Add Vendor</a></h4>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable employees" id="m_table_2">
                  ...
                  <tbody>
                  <?php if(isset($vendor_list) && !empty($vendor_list)){?>
                  <?php $i = 1; foreach($vendor_list as $vendor){?>
                  <tr>
                    <td>
                    <p class="check_select checkboxes"><input type="checkbox" name="quetions_list[]" id="quetions_list<?php echo $vendor['vendor_id']; ?>" value="<?php  echo $vendor['vendor_id']; ?>"><label for="quetions_list<?php echo $vendor['vendor_id']; ?>"></label></p>
                   </td>
                    <td> <?php echo $i++; ?> </td>
                    <td><?php if(!empty($vendor['vendor_name'])) { echo ucfirst($vendor['vendor_name']);} ?> </td>
                    <td><?php if(!empty($vendor['location'])) { echo ucfirst($vendor['location']);} ?> </td>
                    <td> <?php if(!empty($vendor['phone'])) { echo ucfirst($vendor['phone']);} ?> </td>
                    <td> <?php if(!empty($vendor['bank_acno'])) { echo ucfirst($vendor['bank_acno']);} ?> </td>
                    <td> <?php if(!empty($vendor['bank_ifsc_code'])) { echo ucfirst($vendor['bank_ifsc_code']);} ?> </td>
                    <td>
                      <p>
