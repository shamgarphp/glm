...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
          ...
          <div class="m-content">
            ...
            <div class="m-portlet m-portlet--tab">
                  ...
                  <form class="m-form m-form--fit m-form--label-align-right" name="insert_form" id="insert_form" method="POST" action="<?php echo base_url('updateTask?taskId='.$task['task_id']);?>">
                    <div class="m-portlet__body">
                    
                    <div class="row ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <div class="col-md-5">
                       <h5>Task Title</h5>
                        <input type="text" class="form-control m-input m-input--air"  name="task_title"  id="task_title"  placeholder="Enter Task Title" value="<?php echo ucfirst($task['task_title'])?>">
                      </div>
                    
                      <div class="col-md-5">
                        <h5>Task Description</h5>
                        <textarea class="form-control m-input m-input--air" id="task_description" name="task_description" rows="1" placeholder="Enter Task Description"><?php echo ucfirst($task['task_description'])?></textarea>
                      </div>
                    ...
                    <div class="col-md-5">
                      ...
                      <select class="form-control m-input" data-col-index="6" name="location_id" id="location_id">
                       ...
                       <option <?php if($staff_location['location_id'] == $task['location_id']){echo 'selected="selected"';}?> value="<?php echo $staff_location['location_id'];?>"><?php echo $staff_location['area']; ?>                       	
                       </option>
                       <?php } } ?>
                     </select>
                    </div>
                  ...
                  <select class="form-control m-input" data-col-index="6" name="emp_number" id="emp_number">
                    ...
                    <option value="">Select Employee</option>
                       <?php $x = 1; foreach($employee_list as $employee){?>
                    <option <?php if($employee['user_id'] == $task['emp_number']){echo 'selected="selected"';}?> value="<?php echo $employee['user_id'];?>"><?php echo $employee['first_name'];?></option>
                       <?php } } ?>
                    </select>                         
                    </div>
                    </div><br>
               ...
               <!-- <form method="post" id="insert_form"> -->
                ...
                <?php foreach ($days as $day) {?>
                  <tr id="row_<?php echo $x; ?>">
                    <td>
                      <select  id="day_<?php echo $x; ?>" name="day[]" class="form-control item_unit">
                        <option value="">Select Day</option>
                        <option <?php if($day['day'] == 'Monday' || $day['day'] == 'Tuesday' || $day['day'] == 'Wednesday' || $day['day'] == 'Thursday' || $day['day'] == 'Friday' || $day['day'] == 'Saturday' || $day['day'] == 'Sunday'){echo 'selected="selected"';}?> value="<?php echo $day['day'];?>"><?php echo $day['day'];?></option>
                    ...
                    <td><input type="text" name="start_time[]" id="start_time_<?php echo $x; ?>" class="form-control" value="<?php echo $day['start_time'];?>"></td>
                    <td><input type="text" name="end_time[]" id="end_time_<?php echo $x; ?>" class="form-control" value="<?php echo $day['end_time'];?>"></td>
                    <td></td>
                  </tr>
                  <?php $x++; } ?>
                </tbody>
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <?php foreach ($participants as $participant) {?>
                              <tr id="row_<?php echo $x; ?>">
                                <td>
                                  <select id="category_<?php echo $x; ?>" name="category[]" class="form-control item_unit">
                                    <option value="">Select</option>
                                    <option <?php if($participant['category'] == 'Vehicles' || $participant['category'] == 'Books' || $participant['category'] == 'People'){echo 'selected="selected"';}?> value="<?php echo $participant['category'];?>"><?php echo $participant['category'];?></option>
                                    <option value="Vehicles">Vehicles</option>
                                    <option value="Books">Books</option>
                                    <option value="People">People</option>
                                  </select>                                  
                                </td>
                                <td><input type="text" name="type[]" id="type_<?php echo $x; ?>" class="form-control" value="<?php echo $participant['type'];?>"></td>
                                <td><input type="text" name="description[]" id="description_<?php echo $x; ?>" class="form-control" value="<?php echo $participant['description'];?>"></td>
                                <td><input type="text" name="count[]" id="count_<?php echo $x; ?>" class="form-control" value="<?php echo $participant['count'];?>"></td>
                                <td>
                                <select name="resource_id[]" id="resource_id_<?php echo $x; ?>" class="form-control item_unit"><?php if(isset($employee_list) && !empty($employee_list)){?>
                                  <option value="">Select</option>
                                  <?php $i = 1; foreach($employee_list as $employee){?>
                                  <option <?php if($employee['user_id'] == $participant['resource_id']){echo 'selected="selected"';}?> value="<?php echo $employee['user_id'];?>"><?php echo $employee['first_name'];?></option><?php } } ?>
                              	</select>
                                </td>
                                <td></td>
                              </tr>
