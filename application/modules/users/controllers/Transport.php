...
class Transport extends MX_Controller
{
    ...
    //         $data['leave_types']      =  $this->Transport_model->leave_types();
    //         // $data['attendance_list']  =  $this->Transport_model->getall_attendance();
    ...
    //                 // $usercheck  =  $this->Transport_model->attendance_check($employee_id,$newdate);
    ...
    //                     // $result = $this->Transport_model->save_attendance($data);    
