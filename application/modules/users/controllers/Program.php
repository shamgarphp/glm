...
class Program extends MX_Controller
{
    ...
    //         $data['leave_types']      =  $this->Program_model->leave_types();
    //         // $data['attendance_list']  =  $this->Program_model->getall_attendance();
    ...
    //                 // $usercheck  =  $this->Program_model->attendance_check($employee_id,$newdate);
    ...
    //                     // $result = $this->Program_model->save_attendance($data);    
