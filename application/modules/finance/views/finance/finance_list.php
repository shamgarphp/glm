                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Finance Details</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('add_project'); ?>" class="btn sbold green" role="button">Add Finance <i class="fa fa-plus"></i> </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"> 200 </td>
                                                <td>
                                                    <span class="label label-sm label-danger">Approved 
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="btn-group">
