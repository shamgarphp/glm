              ...
              <div class="m-portlet__body">
                ...
                <form class="m-form m-form--fit m--margin-bottom-20" method="post">
                  ...
                  <div class="m-separator m-separator--md m-separator--dashed"></div>
                   <div class="row">
                    <div class="col-lg-12">
                     <input type="submit" class="btn btn-brand m-btn m-btn--icon" name="finance_search" value="Search">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable finance_report" id="m_table_1">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                     <?php if (isset($finance_reports) && !empty($finance_reports)){?>
                    <?php $i=1; foreach ($finance_reports as $finance_report){?>
                    <tr>
                     <td class="check_select checkboxes"><input type="checkbox" name="quetions_list[]" id="quetions_list<?php //echo $questions['quetion_id']; ?>" value="<?php  //echo $questions['quetion_id']; ?>"><label for="quetions_list<?php  //echo $questions['quetion_id']; ?>"></label></td>
                        <td><?php echo $i++; ?></td>
                        <td><?php if(!empty($finance_report['act_amount'])){ echo $finance_report['act_amount']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['expenditure_amount'])){ echo $finance_report['expenditure_amount']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['balance_amount'])){ echo $finance_report['balance_amount']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['area'])){ echo $finance_report['area']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['program_aim'])){ echo $finance_report['program_aim']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['first_name'])){ echo $finance_report['first_name'].' '.$finance_report['last_name']; } else { echo 'No data found.'; }  ?></td>
                          <td><?php if(!empty($finance_report['vendor_name'])){ echo $finance_report['vendor_name']; } else { echo 'No data found.'; }  ?></td>
                        <td><?php if(!empty($finance_report['created_on'])){ echo $finance_report['created_on']; } else { echo 'No data found.'; }  ?></td>
                        <td nowrap="">
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="<?php echo base_url('finance_report_view?finance_report_id='.base64_encode($finance_report['finance_report_id']));?>"  ><i class="la la-eye"></i>View</a>
                               <a class="dropdown-item" href="<?php echo base_url('FinanceReportEdit?financeid='.base64_encode($finance_report['finance_report_id']));?>"><i class="la la-edit"></i>Edit</a>
                               
                                <a class="dropdown-item" href="<?php echo base_url('vbs/vbs/finance_report_delete?finance_report_id='.base64_encode($finance_report['finance_report_id']));?>" onclick="return confirm('Are You Sure');"><i class="la la-tra"></i>Delete</a> 
                            </div> 
                        </span>
