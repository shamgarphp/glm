  ...
  <div class="m-content">
   ...
   <div class="m-portlet m-portlet--mobile">
              ...
              <div class="m-portlet__body">
                ...
                <form class="m-form m-form--fit m--margin-bottom-20">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      &nbsp;&nbsp;
                      <button class="btn btn-danger m-btn m-btn--icon" id="m_reset">
                        <span>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable finance_report" id="m_table_2" width="100%">
                  <thead>
                    <tr>
                      <th>S.No</th>
                      <th>Actual Amount</th>
                 ...
                 <?php if (isset($finance_reports) && !empty($finance_reports)){?>
                  ...
                  <tbody>
                        <td><?php echo $i++; ?></td>
                        <td><?php echo $finance_report['act_amount']; ?></td>
                        <td><?php echo $finance_report['expenditure_amount']; ?></td>
                        <td><?php echo $finance_report['balance_amount']; ?></td>
                        <td nowrap="">
                        <span class="dropdown">
